...
`};var j=new Set,X=new Set,G=new Set,$=new Set;var jt=new Event("navigate"),se=()=>{for(let e of j)e.dispatchEvent(jt)};var y;{let e=new DOMParser,t=d=>{let s=[],l=0,c=/(\{\{[\s\S]*?\}\}|\{[\s\S]*?\})/g;s.push("let out = [];");let p;for(;p=c.exec(d);){let f=p[0],v=p.index;if(s.push(`out.push(${JSON.stringify(d.slice(l,v))});`),f.startsWith("{{"))s.push(f.slice(2,-2).trim());else{let g=f.slice(1,-1).trim();s.push(`out.push(String(${g}));`)}l=v+f.length}return s.push(`out.push(${JSON.stringify(d.slice(l))});`),s.push("return out.join('');"),new Function("server",s.join(`
`))},n=d=>{let s=Array.from({length:10},()=>Math.random()*81+10|0),l=new Array(d),c=p=>{if(p<0)return s[0]+(s[0]-s[1]);if(p>=s.length){let f=s.length;return s[f-1]+(s[f-1]-s[f-2])}return s[p]};for(let p=0;p<d;++p){let f=p/(d-1)*(s.length-1),v=Math.floor(f),g=f-v,x=c(v-1),S=c(v),H=c(v+1),ne=c(v+2),re=.5*(2*S+(-x+H)*g+(2*x-5*S+4*H-ne)*g*g+(-x+3*S-3*H+ne)*g*g*g);l[p]=re}return l},r=(d,s)=>{if(s|=0,s<1)return[];let l=d.length;if(s===1)return[d[l/2|0]];if(s>l)return d;let c=new Array(s);for(let p=0,f;p<s;++p)f=p/(s-1),c[p]=d[Math.round(f*(l-1))];return c},i=(d,s=2)=>parseFloat(d.toFixed(s)),o=([d,s])=>d+'="'+s+'"',a=d=>Object.entries(d).map(o).join(" "),u=(d,s,l,c)=>{let p=s.length;return{path:a({d:s.reduce((f,v,g)=>(f[g]=`${g?"L":"M"} ${i(g/(p-1)*l)} ${i(c-v/100*c)}`,f),new Array(p)).join(" ")}),xTicks:Array.from({length:11},(f,v)=>{let g=i(v/10),x=i(g*l-1),S=a(v?{x:10-c,y:x+(v<10?4:0),transform:"rotate(-90)"}:{x:x+10,y:c-10});return{line:a({x1:x,y1:c,x2:x,y2:c-6}),text:S,label:(g*d.length).toLocaleString()}}),yTicks:Array.from({length:6},(f,v)=>{let g=v/5,x=i(c-g*c+1);return{line:a({x1:0,y1:x,x2:6,y2:x}),text:a({x:10,y:x+(!v||v>4?10:4)}),label:i(g*100)}}),xAxis:a({x1:0,y1:0,x2:0,y2:c}),yAxis:a({x1:0,y1:c,x2:l,y2:c})}},E=Object.fromEntries(Object.entries(h).map(([d,s])=>[d,t(s)])),b=m.map(([d,s,l])=>[d,new RegExp(s),E[l]]),O=1,V=2,W=4,P=8,N=n(1e7);class R{responseType="";responseXML;withCredentials=!1;ownerElement;method;url;data;headers=new Map;status=200;series=N;sampleSeries=r;generateChart=u;getParam(s){return this.data?this.data.get(s):this.url.searchParams.get(s)}get partial(){return this.render(O)[1]}onloadend(s){}open(s,l){this.method=s,this.url=l}setRequestHeader(s,l){this.headers.set(s,l)}render(s){for(let[l,c,p]of b)if(p&&c.test(this.url.href)&&(l&O)===((s??+this.headers.has("X-Requested-With"))&O))return[l,p(this)];return[0,""]}respond=()=>this.onloadend({target:this});send(s){this.data=s;let[l,c]=this.render();this.responseXML=e.parseFromString(c,"text/html"),l&V?setTimeout(this.respond,2e3):this.respond()}}let _=new TextEncoder,L=async(d,s={})=>{let l,c=new ReadableStream({start(S){l=S}}),{headers:p,credentials:f,method:v,body:g}=s,x={headers:p?Array.isArray(p)?new Map(p):p instanceof Headers?p:new Map(Object.entries(p)):new Map,withCredentials:f!=="omit",method:v,url:typeof d=="string"?new URL(d):d instanceof Request?new URL(d.url):d,data:g,status:200,getParam(S){return this.data?this.data.get(S):this.url.searchParams.get(S)},write(S){l.enqueue(_.encode(S))},end(){l.close()},get partial(){return this.render(P)[1]},render(S){for(let[H,ne,re]of b)if(re&&ne.test(this.url.href)&&(S??H)&P)return[H,re(this)];return[0,""]}};return x.write(x.render()[1]),new Response(c)},Q=[["years","year",31104e6],["months","month",2592e6],["days","day",864e5],["hours","hour",36e5],["minutes","minute",6e4],["seconds","second",1e3]],C=[[],[],[],[],[],[]];class qt{static CLOSED=2;readyState=1;url;listeners=new Map;intervals=[];constructor(s){this.url=typeof s=="string"?new URL(s):s;for(let[l,c,p]of b)if(p&&c.test(this.url.href)&&l&W){p(this);break}}addIntervalId(s){this.intervals.push(s)}timeSince(s){let l=Date.now()-s,c,p=-1,f,v,g;for(;++p<6;)c=Q[p],g=C[p],v=c[2],f=l/v|0,l-=f*v,g[0]=(p>3&&f<10?"0":"")+f,g[1]=c[+(f===1)];return C}dispatchEvent(s,l){for(let c of this.listeners.get(s)??[])c({type:s,data:l})}addEventListener(s,l){let c=this.listeners.get(s);c||this.listeners.set(s,c=new Set),c.add(l)}removeEventListener(s,l){let c=this.listeners.get(s);c&&(c.delete(l),c.size||this.listeners.delete(s))}close(){this.listeners.clear();for(let s of this.intervals)clearInterval(s);this.intervals=[]}}let zt=d=>{let s={},l=d,c=0;for(;++c<3&&l&&l!==Object.prototype;){for(let p of Object.getOwnPropertyNames(l))if(!(p in s)){try{if(d[p]===l[p])continue}catch{}try{s[p]=d[p]}catch{}}l=Object.getPrototypeOf(l)}return s};class Ut{constructor(s){this.el=s;let{children:[l,c,p]}=s,f=l.children;this.backBtn=f[0],this.forwardBtn=f[1],f[2].childNodes.length||f[2].appendChild(document.createTextNode("")),this.address=f[2].firstChild,this.viewport=c,this.consoleClear=p?.children[0]?.children[0],this.consoleOut=p?.children[1],this.backBtn.onclick=this.back,this.forwardBtn.onclick=this.forward,this.xhr.ownerElement=s,this.xhr.onloadend=this.onloadend,this.consoleClear&&(this.consoleClear.onclick=this.clear);let v=this.address.nodeValue?.trim();v&&(this.stack.push([new URL(v),!0]),this.index=0),this.render(!0)}el;stack=[];index=-1;backBtn;forwardBtn;address;viewport;xhr=new R;consoleClear;consoleOut;get backPossible(){return this.index>0}get forwardPossible(){return this.index<this.stack.length-1}onloadend=({target:{responseXML:s}})=>this.viewport.replaceChildren(...s?.body.childNodes??[]);back=()=>this.render(this.stack[--this.index][1]);forward=()=>this.render(this.stack[++this.index][1]);clear=()=>this.consoleOut?.replaceChildren();render(s){let l=this.url;this.backBtn.disabled=!this.backPossible,this.forwardBtn.disabled=!this.forwardPossible,this.address.nodeValue=l?.href??"about:blank",s?l&&(this.xhr.open("GET",l),this.xhr.send(void 0)):(te.ownerElement=this.el,Ve())}get url(){return this.stack[this.index]?.[0]}assign(s,l){++this.index,this.replace(s,l)}replace(s,l){this.stack.length=this.index+1,this.stack[this.index]=[s,l],this.render(l)}log(s){if(!this.consoleOut)return;let l=new WeakSet,c=document.createElement("p"),p=JSON.stringify(s,(v,g)=>{if(!(typeof g=="function"||typeof g>"u"))return typeof g=="object"&&g!==null?l.has(g)?void 0:(l.add(g),zt(g)):g}),f=document.createTextNode(p);c.setAttribute("title",p),c.classList.add("mv0"),c.append(f),this.consoleOut.append(c),this.consoleOut.scrollTop=this.consoleOut.scrollHeight}}let ee=new Map,Ue=()=>{Array.from(document.getElementsByClassName("browser"),d=>ee.has(d)||ee.set(d,new Ut(d)))};Ue(),new MutationObserver(Ue).observe(document.body,{childList:!0,subtree:!0});let te={ownerElement:{},get browser(){return ee.get(this.ownerElement.closest(".browser"))},get href(){return this.browser?.url?.href??location.href},assign(d){this.browser?.assign(d,!0)},replace(d){this.browser?.replace(d,!0)}},Vt={pushState(d,s,l){te.browser?.assign(l,!1)},replaceState(d,s,l){te.browser?.replace(l,!1)}},Ve;y={XMLHttpRequest:R,EventSource:qt,location:te,history:Vt,window:{addEventListener(d,s){d==="popstate"&&(Ve=s)}},console:{ownerElement:{},get browser(){return ee.get(this.ownerElement.closest(".browser"))},log(d){this.browser?.log(d)}},fetch:L}}var We=[],_e=[],je=[],Xe=[],Ge=[],$e=[],we,oe=!1,ie=!1,xe=!1,I=new Set,K=new Set,Y=new Set,B=new Set,F=new Set,M=()=>xe=!0,Ke=()=>xe,Ye=()=>xe=!1,ae=e=>We.push(e),Je=()=>We.pop(),Ze=e=>_e.push(e),Qe=()=>_e.pop(),et=e=>je.push(e),tt=()=>je.pop(),nt=e=>Xe.push(e),rt=()=>Xe.pop(),st=()=>we=void 0,ot=()=>we,it=e=>we=e,A=()=>oe=!0,at=()=>oe,lt=()=>oe=!1,k=()=>ie=!0,le=()=>oe=ie=!0,ct=()=>ie,dt=()=>ie=!1,pt=e=>Ge.push(e),mt=()=>Ge.pop(),ce=(e,t)=>$e.push([e,t]),ht=()=>$e.pop();var Xt=new Event("conceal"),Gt=e=>{for(let{isIntersecting:t,target:n}of e)t||n.dispatchEvent(Xt)},Se=new IntersectionObserver(Gt);var $t=e=>{for(let{target:t,isIntersecting:n}of e)t.isIntersecting=n;A()},Re=new IntersectionObserver($t);var Kt=e=>{let t,n,r,i=!1;for(let o of e)({target:t,contentRect:{width:n,height:r}}=o),(n||r||t.offsetParent!=null)&&(t.sizeEntry=o,i=!0);i&&k()},de=new ResizeObserver(Kt);var Yt=new Event("reveal"),Jt=e=>{for(let{isIntersecting:t,target:n}of e)t&&n.dispatchEvent(Yt)},Ae=new IntersectionObserver(Jt);var ut={get:"GET",post:"POST",put:"PUT",delete:"DELETE",href:"GET",action:"GET",src:"GET"},Le=Object.keys(ut),Zt=/\/+$/,J=e=>{let t=Le.find(e.hasAttribute,e),n=e.getAttributeNode("method"),r=t?e.getAttribute(t):"",i=ut[t]??"GET";return n&&(i=n.value.toUpperCase()),r&&(r=r.replace(Zt,""),(!r||r.lastIndexOf(".")<=r.lastIndexOf("/"))&&(r+="/")),y.location.ownerElement=e,[new URL(r,y.location.href),i,!!e.hasAttribute("credentials")]};var Qt=new DOMParser,pe=e=>Qt.parseFromString(e,"text/html");var Z=class extends Set{constructor(n,r,i,o){super();this.url=n;this.withCredentials=r;this.onMessage=i;for(let a of o)this.add(a)}url;withCredentials;onMessage;source;addEventListener(n,r){this.source?.addEventListener(n,r)}removeEventListener(n,r){this.source?.removeEventListener(n,r)}handleError=()=>{if(this.source?.readyState===y.EventSource.CLOSED){this.close(),this.open();for(let n of this)this.addEventListener(n,this.handleMessage)}};handleMessage=({type:n,data:r})=>this.onMessage(this,n,pe(r));open(){this.source=new y.EventSource(this.url,{withCredentials:this.withCredentials}),this.addEventListener("error",this.handleError)}close(){for(let n of this)this.removeEventListener(n,this.handleMessage);this.removeEventListener("error",this.handleError),this.source?.close(),this.source=void 0}add(n){let r=this.size;return super.add(n),r!==this.size&&(r||this.open(),this.addEventListener(n,this.handleMessage)),this}delete(n){let r=super.delete(n);return r&&(this.removeEventListener(n,this.handleMessage),this.size||this.close()),r}clear(){this.close(),super.clear()}reconcileWith(n){let r=this.size,i=this.difference(n),o=n.difference(this);for(let a of i)super.delete(a),this.removeEventListener(a,this.handleMessage);for(let a of o)super.add(a);!r&&this.size?this.open():r&&!this.size&&this.close();for(let a of o)this.addEventListener(a,this.handleMessage)}};var T=class e extends Map{constructor(n){super();this.onPayload=n}onPayload;elements=new Set;static _instance;static get instance(){return e._instance??(e._instance=new e(ae))}addElement=n=>this.elements.add(n);deleteElement=n=>this.elements.delete(n);getEvent(n){return n.getAttribute("sse")||"message"}onMessage=(n,r,i)=>{let o;for(let a of this.elements){let[u,,E]=J(a);this.getEvent(a)===r&&u.href===n.url.href&&E===n.withCredentials&&this.onPayload({target:{ownerElement:a,responseXML:o?o.cloneNode(!0):o=i,status:200}})}};start(){let n=new Map,r=new Map,i=new Set;for(let o of this.elements){let[a,,u]=J(o),E=this.has(a.href)?n:r,b=E.get(a.href);b||E.set(a.href,b=[new Set,new Set,a]),b[+u].add(this.getEvent(o)),i.add(a.href)}for(let[o,[a,u]]of this)i.has(o)||(a.clear(),u.clear(),this.delete(o));for(let[o,[a,u]]of n){let[E,b]=this.get(o);E.reconcileWith(a),b.reconcileWith(u)}for(let[o,[a,u,E]]of r)this.set(o,[new Z(E,!1,this.onMessage,a),new Z(E,!0,this.onMessage,u)])}stop=()=>{for(let[n,r]of this.values())n.clear(),r.clear();this.clear()}};var ft=e=>Object.prototype.toString.call(e)==="[object RegExp]";var gt,vt=e=>gt=e,Et=()=>gt;var bt=new Set,en=["INPUT","SELECT","TEXTAREA"];function he(e){return!e||(typeof e=="string"?e===this:ft(e)?e.test(this):e.some(he,this))}function me({attributes:e}){for(let{name:t}of e)if(he.call(t,this.match))return!1;return!0}var yt=[{match:["if:intersects","ref:width","ref:height"],gate:({sizeEntry:e})=>!e,added(e){let t=e.getBoundingClientRect(),n=[{blockSize:t.height,inlineSize:t.width}];e.sizeEntry={borderBoxSize:n,contentBoxSize:n,devicePixelContentBoxSize:n,contentRect:t,target:e}}},{gate:(e,t)=>e.hasAttribute(`on:attr:${t}`),addedAttr:ce,removedAttr:ce,changed:ce},{match:[/^ref:/,/^link:/],added:k,removed:k,changed:k},{gate:(e,t)=>e.hasAttribute(`ref:${t}`),added:k,removed:k,changed:k},{match:["ref:width","ref:height"],added:e=>de.observe(e),destroyed:e=>de.unobserve(e)},{match:["ref:width","ref:height"],gate:me,removed:e=>de.unobserve(e)},{match:/^ref:/,added:e=>B.add(e),destroyed:e=>B.delete(e)},{match:/^ref:/,gate:me,removed:e=>B.delete(e)},{match:/^link:/,added:e=>F.add(e),destroyed:e=>F.delete(e)},{match:/^link:/,gate:me,removed:e=>F.delete(e)},{match:"autofocus",added:it},{match:"if",added:e=>K.add(e),removed:e=>K.delete(e)},{match:["if",/^if:/],added:A,removed:A,changed:A},{match:/^if:/,added:e=>I.add(e),destroyed:e=>I.delete(e)},{match:/^if:/,gate:me,removed:e=>I.delete(e)},{match:"if:intersects",added:e=>Re.observe(e),removed:e=>Re.unobserve(e)},{match:"if:intersects",gate:({isIntersecting:e})=>e==null,added(e){let{top:t,right:n,bottom:r,left:i}=e.sizeEntry.contentRect;e.isIntersecting=r>0&&n>0&&i<innerWidth&&t<innerHeight}},{match:"on",added:e=>X.add(e),removed:e=>X.delete(e)},{match:/^on:/,gate:(e,t)=>!bt.has(t),added(e,t){bt.add(t),document.addEventListener(t.slice(3),Et(),!0)}},{match:"on:conceal",added:e=>Se.observe(e),removed:e=>Se.unobserve(e)},{match:"on:navigate",added:e=>j.add(e),removed:e=>j.delete(e)},{match:"on:reveal",added:e=>Ae.observe(e),removed:e=>Ae.unobserve(e)},{match:"on:discover",added:pt},{match:"render",added:e=>Y.add(e),removed:e=>Y.delete(e)},{match:"reset",added:e=>G.add(e),removed:e=>G.delete(e)},{match:"scroll",added:e=>$.add(e),removed:e=>$.delete(e)},{match:"sse",added:T.instance.addElement,removed:T.instance.deleteElement},{match:"sse",added:M,removed:M,changed:M},{match:Le.concat("credentials"),gate:e=>e.hasAttribute("sse"),added:M,removed:M,changed:M},{match:"value",gate:e=>!en.includes(e.tagName)&&e.hasAttribute("name"),serialize:(e,t,n)=>n?.formData?.set(e.getAttribute("name"),e.getAttribute("value"))}];var q=1,ke=2,ue=4,Te=8,Ne=16,Ce=32,Me=64,De=128,fe=(e,t,n,r)=>{for(let i of yt)he.call(n,i.match)&&(!i.gate||i.gate(t,n,r))&&(e&q&&i.added?.(t,n,r),e&ke&&i.addedAttr?.(t,n,r),e&ue&&i.removed?.(t,n,r),e&Te&&i.removedAttr?.(t,n,r),e&Ne&&i.changed?.(t,n,r),e&Ce&&i.created?.(t,n,r),e&Me&&i.destroyed?.(t,n,r),e&De&&i.serialize?.(t,n,r))};var z=e=>e?.nodeType===Node.ELEMENT_NODE;var D=(e,t,n)=>{for(let r=0,i=t.length,o,a,u;r<i;++r)if(z(o=t[r])){a=document.createNodeIterator(o,NodeFilter.SHOW_ELEMENT);do for(u of o.attributes)fe(e,o,u.name,n);while(o=a.nextNode())}};var wt=e=>e.tagName==="FORM";var ge=({searchParams:e},t)=>{if(t)for(let[n,r]of t)typeof r=="string"&&e.append(n,r)};var tn=/<!--\s*keml\s*-->/i,nn={stream:!0},rn=new TextDecoder,ve=class{responseType;ownerElement;url;onloadend;init={headers:{}};responseText="";open(t,n){this.init.method=t,this.url=n}setRequestHeader(t,n){this.init.headers[t]=n}set withCredentials(t){t&&(this.init.credentials="include")}async send(t){t&&(this.init.body=t);let{status:n,body:r}=await y.fetch(this.url,this.init);if(r){for await(let i of r){this.responseText+=rn.decode(i,nn);let o;for(;o=tn.exec(this.responseText);)this.respond(this.responseText.slice(0,o.index),n),this.responseText=this.responseText.slice(o.index+o[0].length)}this.respond(this.responseText,n)}}respond(t,n){this.onloadend({target:{status:n,responseXML:pe(t),ownerElement:this.ownerElement}})}};var xt=document.createElement("form"),sn=Object.create(null),Ee=e=>{if(e.timeoutId=clearTimeout(e.timeoutId),e.checkValidity?.()??!0){e.hasAttribute("once")&&Ze(e);let t=new FormData(wt(e)?e:(xt.replaceChildren(e.cloneNode(!0)),xt));D(De,[e],{formData:t});let n=e.getAttribute("redirect"),[r,i,o]=J(e);if(y.location.ownerElement=e,n==="pushState"||n==="replaceState")ge(r,t),y.history[n](sn,"",r),se();else if(n==="assign"||n==="replace")ge(r,t),y.location[n](r);else{i==="GET"&&(t=ge(r,t));let a=new(e.hasAttribute("stream")?ve:y.XMLHttpRequest);a.responseType="document",a.withCredentials=o,a.ownerElement=e,a.onloadend=ae,a.open(i,r),a.setRequestHeader("X-Requested-With","XMLHttpRequest");for(let{name:u,value:E}of e.attributes)u.startsWith("h-")&&a.setRequestHeader(u.slice(2),E);e.isError=!1,e.isLoading=!0,A(),a.send(t)}}};var St=e=>{let t;(t=e.getAttributeNode("throttle"))?e.timeoutId??=setTimeout(Ee,+t.value,e):(t=e.getAttributeNode("debounce"))?(clearTimeout(e.timeoutId),e.timeoutId=setTimeout(Ee,+t.value,e)):Ee(e)};var U=(e,t)=>e&&t&&(e==t||e.startsWith(t+" ")||e.endsWith(t=" "+t)||e.includes(t+" "));function Rt(e){let t=e.indexOf("="),n=(t<0?e:e.slice(0,t)).trim();return n&&(t<0&&!this[n]||t>=0&&this[n]+""!=e.slice(t+1).trim())}var on=[[X,"on",St],[G,"reset",et],[$,"scroll",nt]],At=e=>{let{target:t,type:n}=e;if(z(t)){let r=`on:${n}`,i=t,o;for(;i&&!(o=i.getAttributeNode(r));)i=i.parentElement;if(i&&o){let a=o.value;if((o=i.getAttributeNode(`event:${n}`))&&(y.console.ownerElement=i,i.hasAttribute("log")&&y.console.log(e),o.value.split(",").some(Rt,e)))return;e.preventDefault();for(let[u,E,b]of on)for(i of u)U(a,i.getAttribute(E))&&b(i)}}};var Lt=e=>e.type==="checkbox"?e.checked:e.type==="file"?e.files:e.type==="image"?e.src:e.value;var kt=e=>Object.prototype.toString.call(e)==="[object FileList]";var Oe=(e,t,n=0)=>{for(let r=n,i=e.length,o,a=t.nodeName,u=t.getAttribute?.("key");r<i;++r)if(a===(o=e[r]).nodeName&&u==o.getAttribute?.("key"))return[o,r]};function Tt({name:e}){return this===e}var Pe=e=>e!=null;var an=[["value",e=>e??""],["checked",Pe],["selected",Pe]],w=(e,t,n)=>{let r,i;typeof t=="string"?i=e.getAttributeNode(r=t):(i=t,r=t.name),i?n==null?e.removeAttributeNode(i):i.value!=n&&(i.value=n):n==null||e.setAttribute(r,n);for(let[o,a]of an)if(r===o&&r in e){let u=a(n);e[r]==u||(e[r]=u)}};var Nt=e=>{let t=Array.from(e.attributes);for(let n of t){let{name:r,value:i}=n,o=r.slice(2),a=t.find(Tt,o);r.startsWith("x-")?a?(w(e,n,a.value),w(e,a,i)):(w(e,n),w(e,"d-"+o,""),w(e,o,i)):r.startsWith("d-")&&(a&&(w(e,"x-"+o,a.value),w(e,a)),w(e,n))}},Ct=e=>{e.hasAttribute("state")||(Nt(e),w(e,"state",""))},be=e=>{let t=e.getAttributeNode("state");t&&(w(e,t),Nt(e))};var Mt=(e,t)=>{if(e.nodeName===t.nodeName){if(e.nodeValue===t.nodeValue||(e.nodeValue=t.nodeValue),z(e)){be(e);let n=e.attributes.length,r;for(;n--;)r=e.attributes[n],t.hasAttribute(r.name)||w(e,r);for(let{name:i,value:o}of t.attributes)w(e,i,o);ye.replaceChildren(e,Array.from(t.childNodes))}}else e.replaceWith(t)},ye={after(e,t){e.after(...t)},append(e,t){e.append(...t)},before(e,t){e.before(...t)},prepend(e,t){e.prepend(...t)},replaceWith(e,t){let n=t.length;if(n){let r=Oe(t,e),i,o;r?([i,o]=r,o&&e.before(...t.slice(0,o)),++o):(i=t[0],o=1),n>o&&e.after(...t.slice(o)),Mt(e,i)}else e.remove()},replaceChildren(e,t){let n=e.childNodes,r=t.length,i=n.length,o=0,a,u;for(;o<r;++o)u=Oe(n,a=t[o],o),u?(u[1]===o||e.insertBefore(u[0],n[o]),Mt(n[o],a)):o<i++?e.insertBefore(a,n[o]):e.appendChild(a);for(;i>r;)e.removeChild(n[--i])}};var He=["borderBoxSize","contentBoxSize","devicePixelContentBoxSize","contentRect"],Dt=(e,t)=>{if(t==="width"||t==="height"){let{sizeEntry:n}=e,r=e.getAttribute("measure"),i,o;return He.includes(r)||(r=He[0]),r===He[3]?{width:i,height:o}=n[r]:{inlineSize:i,blockSize:o}=n[r][0],t==="width"?i:o}return t in e?e[t]:e.getAttribute(t)};var Ie=!1,Be=[],ln=()=>{let e;for(;e=Be.pop();)e[0](e[1],e[2])},cn=()=>{Ie=!1},Ot=()=>{!Ie&&Be.length&&(Ie=!0,document.startViewTransition(ln).finished.finally(cn))},Pt=(e,t,n)=>!!document.startViewTransition&&t.hasAttribute("transition")&&Be.push([e,t,n]);var Fe=(e,t,n)=>{let r=e.getAttribute(n);if(r)if(isNaN(+r)){let i=n==="top"?e.scrollHeight-e.clientHeight:e.scrollWidth-e.clientWidth;r==="start"?t[n]=0:r==="center"?t[n]=i/2|0:r==="end"&&(t[n]=i)}else t[n]=+r};var dn=[],Ht=["auto","instant","smooth"],pn=new Event("result"),mn=new Event("failure"),hn=new Event("discover"),It=new Map,qe=()=>{let e,t,n,r,i,o,a,u,E,b,O,V,W,P,N,R,_,L,Q,C;for(;e=tt();)e.reset?.();for(;e=Qe();)w(e,"on");for(;i=Je();){({ownerElement:t,status:N,responseXML:r}=i.target),E=t.getAttribute((t.isError=N>399)?"error":"result"),V=[],n=void 0;for(e of Y)U(E,e.getAttribute("render"))&&V.push([e,r?Array.from((n?n.cloneNode(!0):n=r.body).childNodes):dn]);for(;O=V.pop();)[e,P]=O,W=ye[e.getAttribute("position")]??ye.replaceChildren,Pt(W,e,P)||W(e,P);t.isLoading=!1,A(),t.dispatchEvent(t.isError?mn:pn)}if(Ot(),at()){lt(),b=[];for(e of I)!(e.checkValidity?.()??!0)&&(R=e.getAttributeNode("if:invalid"))&&b.push(R.value),(_=Lt(e))&&(!kt(_)||_.length)&&(R=e.getAttributeNode("if:value"))&&b.push(R.value),e.isIntersecting&&(R=e.getAttributeNode("if:intersects"))&&b.push(R.value),e.isLoading&&(R=e.getAttributeNode("if:loading"))&&b.push(R.value),e.isError&&(R=e.getAttributeNode("if:error"))&&b.push(R.value);E=b.join(" ");for(e of K)U(E,e.getAttribute("if"))?Ct(e):be(e)}if(ct()){dt();for(e of F)for({name:o,value:u}of e.attributes)if(o.startsWith("link:")){o=o.slice(5);for(n of B)for({name:a,value:E}of n.attributes)a.startsWith("ref:")&&U(E,u)&&w(e,o,Dt(n,a.slice(4)))}}for(;e=rt();)L={behavior:Ht.includes(u=e.getAttribute("behavior"))?u:Ht[0]},Fe(e,L,"top"),Fe(e,L,"left"),("top"in L||"left"in L)&&(e.hasAttribute("relative")?e.scrollBy(L):e.scroll(L));for(;e=mt();)e.dispatchEvent(hn);for(;Q=ht();)[e,o]=Q,C=It.get(o),C||It.set(o,C=new Event("attr:"+o)),e.dispatchEvent(C);if(Ke()&&(Ye(),T.instance.start()),e=ot()){st();try{N=e.value.length,e.focus(),e.setSelectionRange(N,N)}catch{}}requestAnimationFrame(qe)};var un=e=>{for(let{addedNodes:t,attributeName:n,oldValue:r,removedNodes:i,target:o}of e)if(D(ue|Me,i),D(q|Ce,t),n){let a=o.hasAttribute(n),u=r!=null,E;a&&!u&&(E=q|ke),!a&&u&&(E=ue|Te),fe(E??Ne,o,n)}},Bt=new MutationObserver(un);var ze=()=>{try{document.cookie=`tzo=${new Date().getTimezoneOffset()};Path=/;SameSite=lax;Max-Age=31536000`}catch{}vt(At),D(q,document.childNodes),Bt.observe(document,{attributeOldValue:!0,attributes:!0,childList:!0,subtree:!0}),document.addEventListener("change",le,!0),document.addEventListener("input",le,!0),document.addEventListener("reset",le,!0),y.window.addEventListener("popstate",se,!0),window.addEventListener("beforeunload",T.instance.stop,!0),requestAnimationFrame(qe)};var Ft=Symbol.for("keml");window[Ft]||(window[Ft]=!0,document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ze,!0):ze());})();
